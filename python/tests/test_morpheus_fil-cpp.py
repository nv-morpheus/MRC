...
def segment_init(seg: srf.Builder):
    ...
    from_file = srfm.FileSourceStage(seg, "from-file", input_file, 1024, 500)
    ...
    # preprocess = srfm.PreprocessFILStage(seg, "preprocess")
    ...
    # inference = srfm.InferenceClientStage(seg, "inference", "abp-nvsmi-xgb", "localhost:8000")

...
def segment_init(seg: srf.Builder):
    ...
    from_file = srfm.FileSourceStage(seg, "from-file", input_file, 32, 10)
    ...
    #                                                     vocab_hash_file=os.path.join(MORPHEUS_ROOT,
    ...
    preprocess = srfm.PreprocessStage(seg, "preprocess", os.path.join(MORPHEUS_ROOT, "data/bert-base-cased-hash.txt"))

    seg.make_edge(from_file, preprocess)
    ...
    inference = srfm.InferenceClientStage(seg, "inference", "sid-minibert-onnx", "localhost:8000")

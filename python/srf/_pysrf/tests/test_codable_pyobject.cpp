...
TEST_F(TestCodablePyobject, PyObject) {
    ...
    static_assert(!is_codable_v<PyObject>, "No support for directly coding cpython objects -- "
                  "use pybind11::object or srf::PyHolder");
    static_assert(!is_decodable_v<PyObject>, "No support for directly coding cpython objects -- "
                  "use pybind11::object or srf::PyHolder");
}
...
TEST_F(TestCodablePyobject, EncodedObjectSimple) {
    ...
    py::object py_dict = py::dict("prop1"_a=py::none(),
                           "prop2"_a=123,
                           "prop3"_a=py::dict("subprop1"_a=1,
                                                      "subprop2"_a="abc"),

...
//   private:
//     // the following method(s) are moved to private from their original scopes to prevent access from deriving
//     classes using RxSinkBase<InputT>::observable; using RxSourceBase<OutputT>::observer;

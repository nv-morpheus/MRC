...
struct ClientStreaming : public BaseContext
{
  ...
  public:
    ...
    ClientStreaming(PrepareFn, std::shared_ptr<grpc::CompletionQueue>);
...
template <typename Request, typename Response>
ClientStreaming<Request, Response>::ClientStreaming(PrepareFn prepare_fn, std::shared_ptr<grpc::CompletionQueue> cq) :
  m_Executor(nullptr),
  m_CQ(cq),
  m_PrepareFn(prepare_fn),
  m_ReadState(this),

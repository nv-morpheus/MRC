...
namespace mrc {
    ...
    TEST_F(TestSegmentModules, ModuleInitializationTest) {
        ...
        auto init_wrapper = [](segment::Builder &builder) {
            ...
            auto configurable_1_mod = builder.make_module<ConfigurableModule>("ModuleInitializationTest_mod2",
                                                                              config_1);
            auto configurable_2_mod = builder.make_module<ConfigurableModule>("ModuleInitializationTest_mod3",
                                                                              config_2);

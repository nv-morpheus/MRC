...
function(configure_iwyu)
  ...
  set(SRF_IWYU_VERBOSITY "1" CACHE STRING "Set verbosity level for include-what-you-use, 1 is default, 1 only shows recomendations and 11+ prints everything")

  find_program(SRF_IWYU_PROGRAM "include-what-you-use")
  ...
  if(SRF_IWYU_PROGRAM)
    ...
    # Make a ccache runner file with the necessary settings. SRF_CCACHE_OPTIONS must be set!
    ...
    message(WARNING "IWYU option SRF_USE_IWYU is enabled but the include-what-you-use was not found. Check iwyu installation and add the iwyu bin dir to your PATH variable.")
  endif(SRF_IWYU_PROGRAM)
endfunction()

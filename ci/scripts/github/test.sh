...
download_artifact "dot_cache-${NVARCH}.tar.bz"
download_artifact "build-${NVARCH}.tar.bz"

tar xf "${WORKSPACE_TMP}/dot_cache-${NVARCH}.tar.bz"
tar xf "${WORKSPACE_TMP}/build-${NVARCH}.tar.bz"
...
tar cfj ${WORKSPACE_TMP}/test_reports-${NVARCH}.tar.bz $(basename ${REPORTS_DIR})

rapids-logger "Pushing results to ${DISPLAY_ARTIFACT_URL}/"
upload_artifact ${WORKSPACE_TMP}/test_reports-${NVARCH}.tar.bz

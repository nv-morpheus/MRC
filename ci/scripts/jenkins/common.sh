...
CMAKE_FEATURES=()
CMAKE_FEATURES+=("-DCMAKE_MESSAGE_CONTEXT_SHOW=ON")
CMAKE_FEATURES+=("-DSRF_BUILD_BENCHMARKS=ON")
CMAKE_FEATURES+=("-DSRF_BUILD_EXAMPLES=ON")
CMAKE_FEATURES+=("-DSRF_BUILD_PYTHON=ON")
CMAKE_FEATURES+=("-DSRF_BUILD_TESTS=ON")
CMAKE_FEATURES+=("-DSRF_USE_CONDA=ON")
CMAKE_FEATURES+=("-DSRF_USE_CCACHE=ON")
CMAKE_FEATURES+=("-DCCACHE_PROGRAM_PATH=$(which sccache)")
export CMAKE_BUILD_ALL_FEATURES="${CMAKE_FEATURES[@]}"
